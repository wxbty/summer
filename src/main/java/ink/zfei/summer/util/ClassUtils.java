...
public abstract class ClassUtils {
     ...
     *  todo 为什么用ConcurrentReferenceHashMap？
     */
    ...
    /**
     * 作用是替换为{Class.forName}，为基础类型（例如“ int”） int.class = forName("java.lang.Integer")
     * 和数组类（例如“ String[]”）返回Class实例。
     * 此外，它还能够解析Java源代码中的内部类名称
